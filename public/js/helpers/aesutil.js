 ...
 * Modif.:   25 août 2018 (bug dans la fonction passPhrase)
 */
...
AesUtil.passPhrase = function () {
  ...
  // var sDate = isoDate.slice(0, 10);

  // gmt date
  var gmtDate = date.toISOString();
  var sDate = gmtDate.slice(0, 10);
  
  // la passphrase
  var pp = "qWe" + sDate + "PoI";
  // console.log('passPhrase: ' + pp + " len=" + pp.length);  

  // retour en base64
  return AesUtil.toBase64(pp);
};
