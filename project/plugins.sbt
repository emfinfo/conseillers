...
// use the last Play sbt plugin for Play projects (03.08.2018) https://www.playframework.com/
...
// pour auto-load d'un changement dans Google Chrome (06.08.2017) https://github.com/jamesward/play-auto-refresh
